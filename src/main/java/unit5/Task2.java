...
public class Task2 {
    ...
    public static void main(String[] args) {
        ...
        try (
            final BufferedReader bufferedReader = new BufferedReader(new FileReader("src/main/resources/someFileWithJavaCode.txt"));
            final FileWriter fileWriter = new FileWriter("src/main/java/unit5/result.txt");
        ) {

            String javaCode = bufferedReader.lines().collect(Collectors.joining());
